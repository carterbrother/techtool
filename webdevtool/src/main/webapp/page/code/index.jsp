...
<head id="Head1" runat="server">
  ...
  <link href="${codeStaticPath}table_form.css" rel="stylesheet" type="text/css" />

  <script type="text/javascript" src="${codeStaticPath}jquery-1.9.1.min.js"></script>
  <script type="text/javascript" src="${codeStaticPath}jquery.artDialog.js?skin=default" ></script>
  <script type="text/javascript" src="${codeStaticPath}iframeTools.js"  ></script>
...
<script src="${codeStaticPath}change-default.js" type="text/javascript"></script>
<script src="${codeStaticPath}select-backstage.js" type="text/javascript"></script>
<script type="text/javascript">
  $(function () {
