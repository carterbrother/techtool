...
import com.danbay.tool.model.DataBaseModel;
import com.danbay.tool.model.FieldModel;
import com.danbay.tool.model.MethodTypeConstants;
import com.danbay.tool.model.TableModel;
import com.danbay.tool.util.GenerateUtil;
import com.danbay.tool.util.SessionUtils;
...
public class DaoService {
    ...
    public static String generateDao_dapeng(TableModel table, HttpServletRequest request)
    {
        ...
        buffer.append("public boolean addRecord(")
                ...
                .append("Model model)\n");
        buffer.append("{\n");
        buffer.append(generateStmt(MethodTypeConstants.addMethod,table.getTableName()));
        buffer.append(generateParameter(table.getFields(),MethodTypeConstants.addMethod));
        buffer.append(generateOutPutStmt());
        buffer.append("}\n");
        //删除方法
        buffer.append("public boolean deleteRecord(int id,int realDelete)\n")
                .append("{\n")
                .append(generateStmt(MethodTypeConstants.deleteMethod,table.getTableName()));
        ...
        buffer.append("public boolean updateRecord(")
                ...
                .append("Model model)\n");
        buffer.append("{\n");
        buffer.append(generateStmt(MethodTypeConstants.updateMethod,table.getTableName()));
        buffer.append(generateParameter(table.getFields(),MethodTypeConstants.updateMethod));
        buffer.append(generateOutPutStmt());
        buffer.append("}\n");
        //单个实体查询
        ...
        buffer.append("{\n");
        buffer.append(generateStmt(MethodTypeConstants.getByIdMethod,table.getTableName()));
        ...
        buffer.append("{\n");
        buffer.append(generateStmt(MethodTypeConstants.getRecordsMethod,table.getTableName()));
